            ...
            <div className="container">
                <div className="row">
                    <div className="col-md-6">
                        ...
                        <a className="btn banner-btn" href="https://chance-app-assets.s3.ap-south-1.amazonaws.com/apk/ChanceAppBeta.apk" style={{width:'152px', height:'41px',backgroundColor:'#87B2E5',borderRadius:'40px',color:'white'}} role="button">Download App</a>
                    </div>
                    <div className="col-md-6 p-0">
                        <img className='vector-2 mt-2' src={vector2} alt="" />
                        <img className='group-image' src={group} alt="" style={{ height: '100%', width: '100%',marginTop:'14px' }} />
                    </div>
                </div>
            </div>
        </div>
