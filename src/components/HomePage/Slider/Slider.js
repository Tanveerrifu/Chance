...
<div id="carouselExampleIndicators" className="carousel slide" data-bs-ride="carousel">
  ...
  <div className="carousel-inner">
    <div className="carousel-item active">
      <img src={slide1} style={{ width: '270px', height: '250px', marginLeft: 'auto', marginRight: 'auto', display: 'block' }} className="d-block mb-2" alt="..." />
...
<a className="btn banner-btn" href="https://chance-app-assets.s3.ap-south-1.amazonaws.com/apk/ChanceAppBeta.apk" style={{width:'152px', height:'41px',backgroundColor:'white',borderRadius:'40px',color:'black',marginLeft:'auto',marginRight:'auto',display:'block'}} role="button">Download App</a>
</div>
   </div>
  );
};
